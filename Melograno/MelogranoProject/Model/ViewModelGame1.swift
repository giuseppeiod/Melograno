    ...
    func loadJson() {
        if let url = Bundle.main.url(forResource: "Game2", withExtension: "geojson") {
            do {
                ...
                self.cards = jsonData[0].map { CardGame1(id: $0.id, correctIndex: $0.correctIndex, imageName: $0.imageName) }
                ...
                self.cardsToOrder = self.cards.enumerated().map {
                    CardGame1(id: $0.offset + self.cards.count , correctIndex: $0.element.correctIndex, imageName: "")
                }
